<template>
  <div class="layout">
    <SiderBar :isCollapse="isCollapse" :menuList="menuList">
      <template slot="logo">
    ...
    <div class="layout-right">
      ...
      <div v-loading.fullscreen="$store.state.loading" :style="routeStyle" class="main-router"
           element-loading-background="rgba(255, 255, 255, 0.7)" element-loading-spinner="el-icon-loading"
