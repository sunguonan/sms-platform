<template>
  <div class="blacklistManage">
    ...
    <div class="list">
      <el-button class="delete" style="margin-left: 0px;margin-right: 26px;" type="primary" @click="importDialog">
        <i class="iconfont icon-xiazai"></i>
        导入
      </el-button>
      <el-button :disabled="ids.length === 0" class="delete" style="padding: 10px 16px;" @click="cancelNums">
        <i class="el-icon-delete icon-sign"></i>
        取消拉黑
      </el-button>
    </div>
    <m-table :columns="tableColumns" :page="pageInfo" :stripe="true" :tableData="tableData" layout="total, prev, pager, next, jumper"
             selection @pageChange="pageChange" @selection-change="selectChange">
      <div slot="btn" slot-scope="{row}">
        <el-tooltip class="item" content="点击取消拉黑" effect="dark" placement="top">
          <el-button class="btn-img" type="text" @click="cancelBlackout(row)">
            <img alt="" src="@/assets/systemManage/xingzhuang.png"/>
          </el-button>
        </el-tooltip>
      </div>
    </m-table>
    ...
    <!-- 取消拉黑动作 -->
    <el-dialog :show-close="false" :visible.sync="centerDialogVisible" center class="dia-black" top="22vh"
               width="322px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button style="padding: 10px 20px;" type="primary" @click="cancelDialog">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
