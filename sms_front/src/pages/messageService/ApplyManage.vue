<template>
  <div class="ApplyManage">
    ...
    <div class="">
      <el-button style="margin-left: 0px;" type="primary" @click="addApply('add')">
        ...
        <div class="card">
          <div class="card-title">
            ...
            <el-tooltip class="item" content="点击切换通道状态" effect="dark" placement="top">
              ...
              <el-switch v-model="item.isActive" active-color="rgba(11,178,144,1)"
                         style="margin-left:15px;width: 32px;height:16px;" @change="getSwitchValue(item)"></el-switch>
            </el-tooltip>
            <el-tooltip class="item" content="点击修改应用" effect="dark" placement="top">
              <img alt="" class="img-edit" src="@/assets/messageService/edit.png" @click="addApply('edit', item)"/>
            </el-tooltip>
            <el-tooltip class="item" content="点击删除当前签名模板" effect="dark" placement="top">
              <img alt="" class="img-del" src="@/assets/messageService/delete.png" @click="deleteApply(item)"/>
            </el-tooltip>
          </div>
    ...
    <!-- 弹框部分 -->
    <ApplyDialog :dialogData="sendApplyDiaData" :dialogShow="dialogShow" :title="applyTitle"
                 @closeDialog="closeDialog"/>
    <!-- 删除动作 -->
    <el-dialog :show-close="false" :visible.sync="centerDialogVisible" center class="dia-apply" top="22vh"
               width="322px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button style="padding: 10px 20px;" type="primary" @click="deteleApplyDialog">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
