<template>
  <div class="TemplateManage">
    ...
    <div class="list">
      <el-button style="margin-left: 0px;margin-right: 26px;" type="primary" @click="addTemplate('add')">
        <i class="el-icon-circle-plus-outline icon-sign"></i>
        添加模板
      </el-button>
      <el-button :disabled="ids.length === 0" class="delete" @click="deleteTemIds">
      ...
      <el-card v-for="(item, index) of cardLiStData" :key="index" class="box-card">
        <div class="card">
          <el-checkbox v-model="item.choseCheck" class="checkbox-style"
                       @change="getTemplateIds(item, $event)"></el-checkbox>
          <div class="card-word">
    ...
    <!-- 修改弹框模块 -->
    <TemplateDialog :diaFormData="templateFormData" :dialogShow="dialogShow" :title="TemTitle"
                    @closeDialog="closeDialog"/>
    <!-- 删除动作 -->
    <el-dialog :show-close="false" :visible.sync="centerDialogVisible" center class="dia-tem" top="22vh" width="322px">
