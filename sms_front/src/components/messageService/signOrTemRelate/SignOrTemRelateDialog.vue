<template>
  <div class="SignOrTemRelateDialog">
    <el-dialog :before-close="closeDialog" :close-on-click-modal="false" :show-close="true" :title="title"
               :visible.sync="dialogShow" height="600px" top="22vh" width="660px">
      <m-form ref="mform" :columns="formColumns" :formData="diaFormData"></m-form>
      <div slot="footer" style="text-align:center;">
        <el-button style="margin-right:30px;padding: 10px 20px;" @click="closeDialog">取消</el-button>
        <el-button style="margin-bottom:20px;padding: 10px 20px;" type="primary" @click="signOrTemplate">确认
        </el-button>
      </div>
    </el-dialog>
  </div>
