<template>
  <div class="RelationSign">
    ...
    <div class="">
      <el-button style="margin-right: 26px;" type="primary" @click="addRelSign('add')">关联更多签名</el-button>
    </div>
    ...
    <!-- 关联弹框动作 -->
    <SignOrTemRelateDialog :diaFormData="signFormData" :dialogShow="dialogShow" :title="SignTitle"
