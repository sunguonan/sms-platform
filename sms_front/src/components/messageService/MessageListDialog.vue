<template>
  <div class="dialog-item">
    <el-dialog :before-close="closeDialog" :close-on-click-modal="false" :show-close="true" :title="title"
      ...
      <m-form ref="mform" :columns="formColumns" :formData="diaFormData"/>
      <div slot="footer" style="text-align:center;">
        <el-button style="margin-right:30px;padding: 10px 20px;font-weight: 300;" @click="closeDialog">取消</el-button>
        <el-button style="margin-bottom:20px;padding: 10px 20px;font-weight: 300;" type="primary"
                   @click="addOrUpdateSign">确认
        </el-button>
      </div>
    </el-dialog>
  </div>
