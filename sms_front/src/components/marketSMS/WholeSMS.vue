    ...
    <m-table :border="false" :columns="tableColumns" :page="pageInfo" :stripe="true" :tableData="tableData"
      ...
      <div slot="btn" slot-scope="{row}">
        <div>
          ...
          <!-- 通过 -->
          <el-tooltip v-if="toggleAdoptState(row)" class="item" content="点击通过" effect="dark" placement="top">
            <el-button class="btn-img" type="text" @click="adoptOrRefuseOrdel('adopt', row)"><img
                alt="" src="@/assets/marketSMS/tongguo.png"/></el-button>
          </el-tooltip>
          <!-- 拒绝 -->
          <el-tooltip v-if="toggleRefuse(row)" class="item" content="点击拒绝" effect="dark" placement="top">
            <el-button class="btn-img" type="text" @click="adoptOrRefuseOrdel('refuse', row)"><img
                alt="" src="@/assets/marketSMS/jujue.png"/></el-button>
          </el-tooltip>
          <!-- 修改 -->
          <el-tooltip v-if="toggleEdit(row)" class="item" content="点击修改" effect="dark" placement="top">
