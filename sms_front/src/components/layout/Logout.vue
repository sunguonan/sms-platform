  ...
  <div class="Logout">
    <ul class="logout-ul">
      <li @click.stop="changePassWord">
        <img alt="" src="@/assets/Logout/password.png"/>
        <span>修改密码</span>
      </li>
      <li @click.stop="goLogin">
        <img alt="" src="@/assets/Logout/logout.png"/>
        <span>退出登录</span>
      </li>
      <li>
        <i class="iconfont icon-quanxianguanli" style="color: rgba(11,178,144,1);"></i>
        <el-link :underline="false" class="link-a" href="http://68.79.7.219:8080/#/login" target="_blank">权限系统
        </el-link>
      </li>
    </ul>
  </div>
