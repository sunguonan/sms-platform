<template>
  <div class="user-info">
    ...
    <!-- 退出动作 -->
    <el-dialog :modal-append-to-body="false" :show-close="false" :visible.sync="centerDialogVisible" center class="dia-logout"
               top="22vh" width="322px">
      <span class="diaLog-span" style="text-align:center;">确认退出系统?</span>
      <span slot="footer" class="dialog-footer">
        <el-button class="btn-sty" @click="logoutDia">取 消</el-button>
        <el-button style="padding: 10px 20px;" type="primary" @click="clearToken">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
